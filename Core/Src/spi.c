...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, MPU_SCK_Pin|MPU_MISO_Pin|MPU_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, BARO_MOSI_Pin|BARO_MISO_Pin);

    HAL_GPIO_DeInit(BARO_SCK_GPIO_Port, BARO_SCK_Pin);
